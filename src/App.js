...
export default function App() {
  ...
  const [watched, setWatched] = useState(function() {//store watched movies 
  ...
  //persist watched list data in local storage and update when a new movie is added to the list
  useEffect(function() {
